  ...
  return (
    <section className='max_padd_container pt-28'>
        <table className='w-full mx-auto'>
            <thead className='bg-slate-900/10 regular-18 sm:regular-22 text-start py22'>
                <tr>
                ...
                {all_products.map((e)=>{
                    if(cartItems[e.id]>0){
                        return <tr key={e.id} className='border-b border-slate-900/20  p-6 medium-14 text-center'>
                            <td className='flexCenter '><img src={e.image} alt="prdtImg" height={43} width={43} className='rounded-lg ring-1 ring-slate-900/5 my-1'/></td>
        ...
        {/* Cart details
         */}
         <div className='flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666p[x]]'>
            <div className='flex flex-col gap-10'>
                ...
                <div>
                    ...
                    <hr/>
                    <div className=' flexBetween py-4'>
                        <h4 className="medium-16">Shipping</h4>
                        <h4 className='text-gray-30 font-semibold'>Free</h4>
                    </div>
                    <hr/>
                    <div  className=' flexBetween py-4'>
                        <h4 className="medium-18">Total:</h4>
                        <h4 className="medium-18">Rs{getTotalCartAmount()}</h4>
                    </div>
                </div>
                <button className='btn_dark_rounded w-44'>Checkout</button>
                <div className='flex flex-col gap-10 '>
                    <h4 className='bold-20 capitalize'>Your coupan code enter here :</h4>
                    <div className='flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10'>
                        <input type="text" placeholder='Coupan Code' className='bg-transparent border-none outline-none '/>
